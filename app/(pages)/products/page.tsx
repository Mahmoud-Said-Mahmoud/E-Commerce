...
import { productApi, ProductFilters } from "@/service/product";
...
export default function ProductsPage() {
  ...
  useEffect(() => {
    ...
    async function getProducts() {
      try {
        ...
        const result = await productApi(page, filters);
  ...
  const toggleBrand = (id: number) => {
    ...
    const exists = selectedBrands.includes(brandId);
  ...
  return (
    <div className="flex min-h-[400px] flex-col items-center justify-center rounded-2xl border border-dashed px-6 text-center">
      ...
      <p className="mt-2 text-sm text-gray-400">
        Try changing the brand, category, price
        or availability.
      </p>
